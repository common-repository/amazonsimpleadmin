 ...
 * @see AsaZend_Loader
 */
require_once ASA_LIB_DIR . 'AsaZend/Loader.php';
 ...
 */
require_once ASA_LIB_DIR . 'AsaZend/Http/Client/Adapter/Interface.php';


/**
 * @see AsaZend_Http_Response
 */
require_once ASA_LIB_DIR . 'AsaZend/Http/Response.php';

/**
 * @see AsaZend_Http_Response_Stream
 */
require_once ASA_LIB_DIR . 'AsaZend/Http/Response/Stream.php';
...
class AsaZend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof AsaZend_Uri_Http) {
            ...
            require_once ASA_LIB_DIR . 'AsaZend/Http/Client/Exception.php';
