 ...
 */
require_once ASA_LIB_DIR . 'AsaZend/Crypt/Rsa/Key.php';
...
class AsaZend_Crypt_Rsa_Key_Private extends AsaZend_Crypt_Rsa_Key
{
    ...
    protected function _parse($passPhrase)
    {
        ...
        if (!$result) {
             ...
             */
            require_once ASA_LIB_DIR . 'AsaZend/Crypt/Exception.php';
    ...
    public function getPublicKey()
    {
        if ($this->_publicKey === null) {
             ...
             */
            require_once ASA_LIB_DIR . 'AsaZend/Crypt/Rsa/Key/Public.php';
